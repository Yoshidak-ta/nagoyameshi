...
public class AdminStoreController {
	...
	public String edit(@PathVariable(name = "id")Integer id, Model model) {
		...
		StoreEditForm storeEditForm = new StoreEditForm(store.getId(), store.getName(), store.getCategory(), null, store.getDescription(), store.getBusinessHours(), store.getPostalCode(), store.getAddress(), store.getPhoneNumber(), store.getMap(), store.getTransportation(), store.getPay(), store.getHomePage());
